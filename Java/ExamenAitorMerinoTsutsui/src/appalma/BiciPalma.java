...
public class BiciPalma {
	...
	public static void main(String[] args) {
		...
		/*
		 * caso TEST visualizar estado de la estacion muestra id, direccion,
		 * anclaje
		 */
		...
		/*
		 * // generar anclaje random for (int i: bicicletas){
		...
		TarjetaUsuario tarjetaUsuario = new TarjetaUsuario(45678, true);
